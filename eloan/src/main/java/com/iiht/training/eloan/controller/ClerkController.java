...
public class ClerkController {
	...
	public ResponseEntity<List<LoanOutputDto>> allAppliedLoans() throws LoansException {
	...
	public ResponseEntity<ProcessingDto> processLoan(@PathVariable Long clerkId,
													 ...
													 @RequestBody @Valid ProcessingDto processingDto, BindingResult result) throws LoansException  {
		if(result.hasErrors())
		{
