...
public class ManagerController {
	...
	public ResponseEntity<List<LoanOutputDto>> allProcessedLoans() throws LoansException {
	...
	public ResponseEntity<RejectDto> rejectLoan(@PathVariable Long managerId,
												...
												@RequestBody @Valid RejectDto rejectDto, BindingResult result) throws LoansException{
		if(result.hasErrors())
		{
	...
	public ResponseEntity<SanctionOutputDto> sanctionLoan(@PathVariable Long managerId,
												@PathVariable Long loanAppId,
												@RequestBody @Valid SanctionDto sanctionDto, BindingResult result) throws LoansException{
		if(result.hasErrors())
		{
			LoansException.toErrExceptions(result.getAllErrors());
		}
